...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\RC-Files\PythonProjects\Pokemon Egg Tries for Shiny'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\RC-Files\PythonProjects\Pokemon Egg Tries for Shiny\Scripts\deactivate.nu'
